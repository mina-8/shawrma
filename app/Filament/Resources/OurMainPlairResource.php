...
use App\Filament\Resources\OurMainPlairResource\Pages;
use App\Filament\Resources\OurMainPlairResource\RelationManagers;
...
class OurMainPlairResource extends Resource
{
    protected static ?string $model = OurMainPlair::class;
    ...
    {
        return __('filament-panels::resources/pages/ourmainplair.title');
    }
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\DeleteAction::make()
                    ...
                    ->before(function (OurMainPlair $record) {
    ...
    {
        return [
            'index' => Pages\ListOurMainPlairs::route('/'),
            'create' => Pages\CreateOurMainPlair::route('/create'),
            'edit' => Pages\EditOurMainPlair::route('/{record}/edit'),
        ];
    }
}
